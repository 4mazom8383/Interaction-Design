...
const Week4 = () => {
  ...
  if(errors.password || errors.email){
    /*alert("heel");*/
    document.getElementById("email").style.cssText = "border: 2px solid red; color: red";
    document.getElementById("txt_label1").style.cssText = "color: red";

    document.getElementById("password").style.cssText = "border: 2px solid red; color: red";
  ...
  return (
    <StyledWrapper>
      ...
      <form onSubmit={handleSubmit(onSubmit)} >
        ...
        <label>
          <StyledLabel id="txt_label1">Email</StyledLabel>
          <StyledInput id="email" autoFocus type="text" name="email" placeholder="Email" ref={register()}/>
